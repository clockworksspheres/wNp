...
# --- CONFIG ---
ZIP_CODE = "10001"  # Change to your ZIP
COUNTRY = "US"
UPDATE_INTERVAL = 60
HISTORY_SIZE = 10
...
class Chart(Widget):
    ...
    def update_graphics(self, *args):
        ...
        with self.canvas.after:
            ...
            texture = lbl.texture
            if texture:
                Rectangle(texture=texture, pos=(pad, h - 25), size=texture.size)
...
class WeatherApp(MDApp):
    ...
    def update_weather(self, *args):
        ...
        # Update cards
        self.screen.ids.temp.value = f"{temp:.1f} °C"
        self.screen.ids.humid.value = f"{humid:.0f} %"
        self.screen.ids.press.value = f"{press:.0f} hPa"
